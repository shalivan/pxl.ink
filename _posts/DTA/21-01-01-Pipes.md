...
FBX export: ```$HIP/out/`opname("..")`/`details(0,'name')`/$OS.fbx```
velum I/O  / COPtextures
...
| ------------------------------------- | ------------------------------------------------------------ | --------------------- | ------------------------- | ----------------------------- |
| ![Gl \| 200](/src/pipe/axies_gl.png)  | Houdini, Maya, Substance, Modo, Godot, Marmoset, **Open GL** | **R, Y-Up**<br> X>Y>Z | XYZ                       | XYZW                          |
| ![\| 200](/src/pipe/axies_blend.png)  | 3ds Max, Blender, CryEngine, Auto Cad, Source, SketchUp      | **R, Z-Up**<br>Z>Y>X  | X,-Z,Y                    | X,-Z,Y,W                      |
| ![DXl \| 200](/src/pipe/axies_dx.png) | Unity, ZBrush, Cinema4D. LightWave, **Direct X**             | **L, Y-up**<br>Y>Z>X  | -X,Y,Z                    | X,-Y,-Z,W                     |
| ![UEl \| 200](/src/pipe/axies_u.png)  | Unreal                                                       | **L, Z-up** <br>Z>X>Y | X,Z,Y                     | -X, -Z,-Y,W                   |
|                                       |                                                              |                       |                           |                               |
