...
**Material** have differenc t colors based on chemical compositition and reflecting differennt lenghts (diffuse reflection)
...
- **RYB** - `Subtractive`. Mixing get darker (ink CMYK) Primary: `Red`, `Yellow`, `Blue` sec: `Orange` (Red+Yellow), `Purple` (Red + Blue), `Green` (Yellow + Blue). For mixing pigments and light filters, because it produce wider range of colors (better greens)
...
Difference in Hue and Contrast between colors in palete should differ to have different contrast between colors.  We can have contrast in Hue (temp), Saturation, Value, Quantity. 
...
- Different intervals between colors.  It will be more design ready and open possibilities. 
...
| YCoCg | Y (value) Co Cg V2 - Angle (hue) + Amp (Saturation) |             |         |                     |
...
| HardLight        | Contrast  |                                                    |                      | Medium        |                                                                                               | 0.5          |
| LinearLight      | Contrast  |                                                    |                      | Medium        |                                                                                               | 0.5          |
| **SoftLight**    | Contrast  | Quadratic blend & conditional                      | ~12–15               | **Medium**    | Subtle photo-grade tones /  tonal tint (gentler cousin of Overlay)                            | 0.5          |
| PinLight         | Contrast  |                                                    |                      | Medium        |                                                                                               | 0.5          |
