...
- **Optical Illusions**:  
	- Perception can be altered by context, contrast, and adjacent colors (e.g., simultaneous contrast effects). [Examples](https://michaelbach.de/ot/index.html).
- **Color Blindness**:  Affects ~8% of males and ~0.5% of females. Common types include:
 ...
 - [YT The Amazing Math behind Colors!](https://youtu.be/gnUYoQ1pwes?t=1086)   , [YT only Video](https://www.youtube.com/watch?v=HKtTNOgfhAU), [YT Color](https://youtu.be/1i8s8knHFTs)  https://hg2dc.com/  


# Color

Value / Saturation Hue, Saturation, and Lightness (HSL)  Contrast
...
- **Design Implication**: When working with highly saturated colors, consider their natural value-chroma relationship to maintain harmony and realism. Avoid pushing hues beyond their natural intensity.

**Some colors with the same brightness have different perceived values**:
...
- **Design Implication**: Be aware that colors of "equal brightness" might not visually balance; adjust accordingly.
...
- **Design Implication**: Use advancing colors for focal points and receding colors for background elements to create depth.

### **Composition in Color Design**
